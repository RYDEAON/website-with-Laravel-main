        ...
        <form method="POST" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <div class="col-md-3 mt-5 mb-5">
                    <label for="image" class="control-label">Profil fotoğrafı Ekleyin</label>
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="user_image" name="user_image" onchange="previewImage(event)">
                            <label class="custom-file-label" for="user-image">Dosya Seçiniz</label>
                        </div>
                    </div>
                </div>
                <div class="col-md-9">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        <label for="username">Kullanıcı Ad</label>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        <label for="province">Bölge</label>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <button type="submit" class="btn btn-primary">Kullancıyı Güncelle</button>
            </div>
        </form>
    </div>
</div>
