...
@section('content')
<p>Nakliye Admin Sayfasına Hoşgeldiniz</p>

<a class="btn btn-warning my-2" href="{{ route('shippings.create') }}">Yeni Servis</a>
<div style="overflow-x: auto;">
    <table class="table table-stripped mt-3">
        <thead style="background-color: #6777ef;">
            ...
            <th style="color: #fff; white-space: nowrap;">İsim</th>
            ...
            <th style="color: #fff;">Total Değer</th>
            <th style="color: #fff;">Kargo Süresi </th>
        </thead>
        <tbody>
                ...
                <td>
                    <div class="btn-action">
                        ...
                        <a class="btn btn-info btn-sm" href="{{route('shippings.edit', $shipping->id)}}">
                            ...
                            <span class="d-none d-sm-inline-flex">Güncelle</span>
                        </a>
                        @endcan
                        ...
                        <form action="{{ route('shippings.destroy', $shipping->id) }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this shipping?');">
                                ...
                                <span class="d-none d-sm-inline-flex">Sil</span>
                            </button>
                            @endcan
                        </form>
                    </div>
