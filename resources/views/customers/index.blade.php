    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card" style="border-radius: 16px;">
                <div class="card-body">
                    <div class="row">
                        <a class="btn btn-warning my-3" href="{{ route('customers.create') }}">Yeni Kullanıcı</a>
                        ...
                        <table class="table table-stripped mt-3" id="scrolling-1">
                            <thead style="background-color: #6777ef;">
                                <tr>
                                    ...
                                    <th style="color: #fff; white-space: nowrap;">İSİM</th>
                                    <th style="color: #fff;">Email</th>
                                    <th style="color: #fff;">Bölge</th>
                                    <th style="color: #fff;">Telefon</th>
                                    <th style="color: #fff;">Adres</th>
                                    <th style="color: #fff;">Şehir</th>
